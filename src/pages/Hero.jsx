...
<div className='w-full overflow-hidden'>
    <div className="pt-6 md:mt-28 lg:mt-32 md:mx-10 mx-4 mt-24 bg-[#EEEEEE] rounded-2xl ">
        <div className="flex items-center justify-center w-full bg-[#EEEEEE]">
            <div className="inline-flex flex-col items-center justify-center md:px-12 md:pt-12 md:pb-8 p-4 bg-[#EEEEEE]">
                <h3 className=" font-bold text-center font-oakes md:text-5xl lg:text-7xl sm:text-3xl text-2xl gap-y-1">
        ...
        <div className ="flex items-center justify-center md:gap-4 gap-2">
            <button
                className ="bg-[#0065FB] md:py-4 md:px-6 px-4 py-2 text-[#EEEEEE] font-sofia font-semibold rounded-lg md:rounded-xl" style={{ boxShadow: '0px 12px 48px 0px rgba(1, 107, 252, 0.32)'}}>
                Request a Demo
            </button>
            <button className="md:py-4 md:px-6 md:rounded-lg px-3 py-2 rounded-md text-[#000000] font-sofia font-semibold bg-white">
                Contact Sales
            </button>
        </div>
        <div className="relative h-[240px] sm:h-[432px] lg:h-[744px] w-full ">
            ...
            <div className="absolute z-30 bottom-0 left-0 right-0 sm:h-64 h-24 bg-gradient-to-t from-gray-50 to-transparent">
            </div>
        </div>
       </div>
   </div>
