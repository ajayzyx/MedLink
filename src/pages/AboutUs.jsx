...
export default function AboutUs() {
  return (
    <div id='About'>
        <div className="w-full bg-[#FFFFFF] overflow-hidden mt-28 pt-20">
            ...
            <div className='flex sm:flex-row flex-col sm:justify-between font-oakes mt-16 sm:mx-16 sm:mt-32 gap-6'>
                <div className=''>
                    <img src={AboutUs1} alt="" className='w-[280px] sm:w-[625px]' />
                </div>
                <div className='sm:w-[640px] w-[320px] font-oakes'>
                    <h3 className='sm:text-5xl text-xl font-semibold text-center'>
                        Vision
                    </h3>
                    <p className=' text-[#737373] font-normal sm:text-4xl text-lg text-left sm:p-14 p-4'>
            ...
            <div className='flex sm:flex-row flex-col justify-between items-center font-oakes sm:mx-16 sm:mt-32 gap-6'>
                ...
                <div>
                    <img src={AboutUs2} alt="" className='sm:w-[578px] w-[240px] mt-16 sm:mt-0' />
                </div>
            </div>
            </div>
        </div>
