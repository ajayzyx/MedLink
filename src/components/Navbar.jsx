...
function Navbar() {
  return (
    <nav
      className="bg-[#FFFFFF] fixed top-0 right-0 z-40 w-full shadow-lg px-6 py-4 lg:px-16"
      style={{ boxShadow: '0px 6px 24px 0px rgba(217, 217, 217, 0.54)' }}
    >
      <div className="flex gap-2 items-center w-full justify-between lg:h-16">
        <div className="inline-flex sm:gap-4 gap-2 justify-center items-center">
          ...
          <span className="lg:text-2xl lg:font-bold font-semibold sm:font-semibold sm:text-xl text-2xl font-oakes text-[#2A2A2A]">
            MedlinkPro
          </span>
        </div>
